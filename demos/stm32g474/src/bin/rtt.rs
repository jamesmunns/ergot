//! Ergot over RTT transport (no defmt)
//!
//! Tests: RttReader, RttWriter, ergot ping over RTT
//!
...
async fn main(spawner: Spawner) {
    ...
    let (_defmt_ch, ergot_up, ergot_down) = init_rtt_channels();
    // defmt channel unused in this binary — no init, writes are no-ops
