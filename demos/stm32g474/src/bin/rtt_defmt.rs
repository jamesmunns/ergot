//! Ergot over RTT + defmt to separate RTT channel
//!
//! Tests: defmt-sink-rtt, RttReader, RttWriter
//!
//! Host: ergot-rtt-host --chip STM32G431KBTx --up-channel 1 --down-channel 0 \
//!         --elf target/thumbv7em-none-eabihf/release/rtt-defmt --defmt-channel 0
